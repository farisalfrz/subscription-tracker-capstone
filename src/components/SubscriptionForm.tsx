...
// Props for the form: add, update, and edit data
type FormProps = {
...
export default function SubscriptionForm({
  ...
  // Determine if editing mode is active
  ...
  // Placeholder for cost input based on currency
  ...
  return (
    ...
    <form
      ...
      className="bg-white p-6 rounded-lg border border-slate-200 space-y-6 mb-6 shadow-sm"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center">
              <select
                ...
                className="h-full rounded-md border-transparent bg-transparent py-0 pl-2 pr-7 text-gray-500 focus:ring-2 focus:ring-inset focus:ring-slate-600 sm:text-sm cursor-pointer"
              >
        ...
        <div>
          ...
          <select
            ...
            className="appearance-none block w-full px-3 py-2 bg-slate-50 border border-slate-300 rounded-md text-sm shadow-sm text-slate-900 focus:outline-none focus:border-slate-500 focus:ring-1 focus:ring-slate-500 bg-chevron-down bg-no-repeat bg-right pr-8 cursor-pointer"
          >
      ...
      <button
        type="submit"
        className="w-full bg-indigo-600 text-white font-bold py-2.5 px-4 rounded-lg hover:bg-indigo-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 cursor-pointer"
      >
